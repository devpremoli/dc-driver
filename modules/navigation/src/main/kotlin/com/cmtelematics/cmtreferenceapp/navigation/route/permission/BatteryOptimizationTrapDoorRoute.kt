...
@Parcelize
class BatteryOptimizationTrapDoorRoute(
    override val shouldReturnToOriginalScreenOnFinish: Boolean
) : BaseOnboardingRoute(this, shouldReturnToOriginalScreenOnFinish) {

    companion object : Factory<BatteryOptimizationTrapDoorRoute>() {

        override val path = "BatteryOptimizationTrapDoor"

        override fun create(bundle: Bundle?) = BatteryOptimizationTrapDoorRoute(
