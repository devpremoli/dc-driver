...
@Parcelize
class FineLocationTrapDoorRoute(
    override val shouldReturnToOriginalScreenOnFinish: Boolean
) : BaseOnboardingRoute(this, shouldReturnToOriginalScreenOnFinish) {

    companion object : Factory<FineLocationTrapDoorRoute>() {

        override val path = "fineLocationTrapDoor"

        override fun create(bundle: Bundle?) = FineLocationTrapDoorRoute(
