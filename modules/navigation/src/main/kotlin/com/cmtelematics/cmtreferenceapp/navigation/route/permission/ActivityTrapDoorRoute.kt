...
@Parcelize
class ActivityTrapDoorRoute(
    override val shouldReturnToOriginalScreenOnFinish: Boolean
) : BaseOnboardingRoute(this, shouldReturnToOriginalScreenOnFinish) {

    companion object : Factory<ActivityTrapDoorRoute>() {

        override val path = "activityTrapDoor"

        override fun create(bundle: Bundle?) = ActivityTrapDoorRoute(
