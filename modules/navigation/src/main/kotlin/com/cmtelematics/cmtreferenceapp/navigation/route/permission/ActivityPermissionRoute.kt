...
@Parcelize
class ActivityPermissionRoute(
    override val shouldReturnToOriginalScreenOnFinish: Boolean
) : BaseOnboardingRoute(this, shouldReturnToOriginalScreenOnFinish) {

    companion object : Factory<ActivityPermissionRoute>() {

        override val path = "activityPermission"

        override fun create(bundle: Bundle?) = ActivityPermissionRoute(
