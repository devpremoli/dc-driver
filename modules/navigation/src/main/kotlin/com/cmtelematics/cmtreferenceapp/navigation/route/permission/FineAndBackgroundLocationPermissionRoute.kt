...
@Parcelize
class FineAndBackgroundLocationPermissionRoute(
    override val shouldReturnToOriginalScreenOnFinish: Boolean
) : BaseOnboardingRoute(this, shouldReturnToOriginalScreenOnFinish) {

    companion object : Factory<FineAndBackgroundLocationPermissionRoute>() {

        override val path = "fineAndBackgroundLocationPermission"

        override fun create(bundle: Bundle?) = FineAndBackgroundLocationPermissionRoute(
