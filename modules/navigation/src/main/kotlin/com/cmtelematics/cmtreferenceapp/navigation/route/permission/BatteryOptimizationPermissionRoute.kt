...
@Parcelize
class BatteryOptimizationPermissionRoute(
    override val shouldReturnToOriginalScreenOnFinish: Boolean
) : BaseOnboardingRoute(this, shouldReturnToOriginalScreenOnFinish) {

    companion object : Factory<BatteryOptimizationPermissionRoute>() {

        override val path = "batteryOptimizationPermission"

        override fun create(bundle: Bundle?) = BatteryOptimizationPermissionRoute(
