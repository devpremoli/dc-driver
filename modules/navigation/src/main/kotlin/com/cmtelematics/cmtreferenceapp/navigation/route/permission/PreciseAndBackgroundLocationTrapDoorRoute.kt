...
@Parcelize
class PreciseAndBackgroundLocationTrapDoorRoute(
    override val shouldReturnToOriginalScreenOnFinish: Boolean
) : BaseOnboardingRoute(this, shouldReturnToOriginalScreenOnFinish) {

    companion object : Factory<PreciseAndBackgroundLocationTrapDoorRoute>() {

        override val path = "preciseAndBackgroundLocationTrapDoor"

        override fun create(bundle: Bundle?) = PreciseAndBackgroundLocationTrapDoorRoute(
