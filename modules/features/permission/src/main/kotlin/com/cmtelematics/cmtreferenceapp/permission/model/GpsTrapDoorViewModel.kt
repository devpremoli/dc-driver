...
/**
 * This ViewModel handles the high accuracy location permission state refreshing for trapdoor feature.
 *
 ...
 */
@HiltViewModel
internal class GpsTrapDoorViewModel @Inject constructor(
    navigator: Navigator,
    ...
    requiredPermissionType = PermissionType.HighAccuracy
)
