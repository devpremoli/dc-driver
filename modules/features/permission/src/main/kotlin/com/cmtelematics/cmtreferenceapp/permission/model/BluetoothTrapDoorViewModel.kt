...
/**
 * This ViewModel handles the bluetooth based permission state refreshing for trapdoor feature.
 *
 ...
 */
@HiltViewModel
internal class BluetoothTrapDoorViewModel @Inject constructor(
    navigator: Navigator,
