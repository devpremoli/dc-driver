...
/**
 * ViewModel for the Bluetooth adapter disabled trapdoor screen.
 *
 ...
 */
@HiltViewModel
internal class BluetoothDisabledTrapDoorViewModel @Inject constructor(
    navigator: Navigator,
    ...
    requiredPermissionType = PermissionType.BluetoothAdapter
)
