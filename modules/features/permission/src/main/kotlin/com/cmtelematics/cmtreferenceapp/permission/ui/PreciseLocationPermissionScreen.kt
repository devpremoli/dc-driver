...
import com.cmtelematics.cmtreferenceapp.permission.model.PreciseLocationPermissionViewModel
...
@Composable
internal fun PreciseLocationPermissionScreen(viewModel: PreciseLocationPermissionViewModel = hiltViewModel()) {
    PreciseLocationPermissionScreenContent(
...
@Composable
private fun PreciseLocationPermissionScreenContent(
    ...
    PermissionRequesterScreenScaffold(
        ...
        PermissionDescription(
            ...
            description = stringResource(R.string.precise_location_permission_description),
        ...
        Image(
            ...
            painter = painterResource(
                id = R.drawable.ic_precise_location_permission
            ),
...
@Preview
@Composable
private fun PreciseLocationPermissionScreenContentPreview() {
    AppTheme {
        PreciseLocationPermissionScreenContent(
