...
/**
 * This ViewModel handles the battery optimization permission state refreshing for trapdoor feature.
 *
 ...
 */
@HiltViewModel
internal class BatteryOptimizationTrapDoorViewModel @Inject constructor(
    navigator: Navigator,
    ...
    requiredPermissionType = PermissionType.BatteryOptimization
)
